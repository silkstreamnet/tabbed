        ...
        if (_tabbedContainers && _tabbedContainers.length > 0)
        {
            _tabbedContainers.each(function()
            {
                ...
                _tabbedContainer.find(t_settings.selector).each(function()
                {
                    ...
                    setAttr($(this),'data-tabbed-id',tabId);
                });
                ...
                if (foundTabs.length)
                {
                    ...
                    {
                        defaultShowID = getAttr(_defaultShowOb,'data-tabbed-id');
                    }
                    ...
                    _tabbedMenu.find('a.tabbed-menu-btn').each(function(){
                        ...
                        var ftid = getAttr(_tabbedMenuButton,'data-tabbed-id');
                        ...
                        if (ftid != '')
                        {
                            ...
                            _tabbedMenuButton.click(function(e){
                                ...
                                {
                                    _tabbedContainer.find(t_settings.selector).each(function(){
                                        if ($(this).attr('data-tabbed-id') != ftid)
                                        {
                                    ...
                                    _tabbedContainer.find(t_settings.selector+'[data-tabbed-id="'+ftid+'"]').show().addClass('on');
                                    _tabbedMenuButton.parent().addClass('on');
                                }
                                e.preventDefault();
                            });
